...
AnimationSceneWindow::AnimationSceneWindow(QWidget *parent) : QWidget(parent),
                                                              m_ui(new Ui::AnimationSceneWindow)
{
    ...
    sceneObserver->SetRenderWindow(m_vtkWidget->renderWindow());
    ...
    this->setWindowTitle("AnimationSceneWindow");
}
