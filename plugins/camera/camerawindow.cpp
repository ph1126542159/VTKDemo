    ...
    m_ui(new Ui::CameraWindow)
{
    ...
    m_vtkWidget->renderWindow()->AddRenderer(m_topLeftRenderer);
    m_vtkWidget->renderWindow()->AddRenderer(m_topRightRenderer);
    m_vtkWidget->renderWindow()->AddRenderer(m_bottomLeftRenderer);
    m_vtkWidget->renderWindow()->AddRenderer(m_bottomRightRenderer);
