...
//            m_lineWidget->AddObserver(vtkCommand::EndInteractionEvent, new LineCallback);
    ...
    case WT_Sphere:
        if (!m_sphereWidget) {
            ...
            m_sphereWidget->SetInteractor(m_vtkWidget->interactor());
    ...
    case WT_Box:
        if (!m_boxWidget) {
            ...
            m_boxWidget->SetInteractor(m_vtkWidget->interactor());
    ...
    case WT_ImplicitPlane:
        if (!m_implicitPlaneWidget) {
            ...
            m_implicitPlaneWidget->SetInteractor(m_vtkWidget->interactor());
