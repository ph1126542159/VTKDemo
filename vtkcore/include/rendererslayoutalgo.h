...
namespace VtkUtils {
template <int count>
inline void layoutRenderers(const QList<vtkRenderer*>& )
{
...
// |X|X| X |
template <>
inline void layoutRenderers<11>(const QList<vtkRenderer*>& )
{
...
// |X|X|X|X|
template <>
inline void layoutRenderers<12>(const QList<vtkRenderer*>& )
{
